...
namespace CarManagementSystem.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Make,Model,Year,LicensePlate,Price,isSold")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Make,Model,Year,LicensePlate,Price,isSold")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
